 ...
 * function _checkLanguageDirection was deleted to avoid switch of direction when hover over a rtl words in a ltr direction + direction to be set to inherit in line 2440 to be inherited from the main direction
 */
...
//                this._checkLanguageDirection();
    ...
    (function() {
        ...
        function prepInput($input, www) {
            ...
            try {
                !$input.attr("dir") && $input.attr("dir", "inherit");
            } catch (e) {
            }
            return $input;
        }
