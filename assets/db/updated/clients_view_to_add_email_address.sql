/****** Object:  View [dbo].[clients_view]    Script Date: 26/05/2025 19:07:05 ******/
...
SELECT
    ...
    CASE WHEN vendors.company_id IS NULL THEN ( '' + vendors.contact_id ) ELSE ( '' + vendors.company_id ) END AS member_id,
    'suppliers' AS model,
    vendors.createdBy,
    vendors.createdOn,
    vendors.modifiedBy,
...
SELECT
    ...
    CASE WHEN partners.company_id IS NULL THEN ( '' + partners.contact_id ) ELSE ( '' + partners.company_id ) END AS member_id,
    'partners' AS model,
    partners.createdBy,
    partners.createdOn,
    partners.modifiedBy,
