...
VALUES
-- System/Auth Messages (Note: These are usually not meant for DB management but included for completeness)
...
<b>Priority:</b> %s 
<br />
<b>Description:</b> %s', 1, 5), -- Note: This key appears twice with slightly different content, using the first occurrence's content.
