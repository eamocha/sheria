...
var gridDataSrc = new kendo.data.DataSource({
    transport: {
        read: {
            url: getBaseURL('money') + "accounts/partners",
            dataType: "JSON",
            type: "POST",
            complete: function () {
    ...
    gridOptions = {
        ...
        columns: [
            {
                ...
                template: '<div class="dropdown">' + gridActionIconHTML + '<div class="dropdown-menu" role="menu" aria-labelledby="dLabel">' +
                        ...
                        '<a class="dropdown-item" href="javascript:;" onclick="settlementOfAccount(\'#= id #\')">' + _lang.settlementOfPartnerAccount + '</a>' +
            ...
            {field: 'account_number', template: '<a href="' + getBaseURL('money') + 'accounts/edit/#= id #">#= account_number #</a>', title: _lang.accountTypeAccountNumber.sprintf([_lang.partner]), width: '75px'},
        ...
        toolbar: [{
                ...
                template: '<div class="col-md-5 no-padding">'
                        + '<h4 class="col-md-5 no-padding-right">' + _lang.partnersAccounts + '</h4>'
...
function exportAccountsToExcel() {
    ...
    newFormFilter.attr('action', getBaseURL('money') + 'accounts/export_partners_to_excel').submit();
}
