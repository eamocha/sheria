 ...
 * Line 329 was replaced by the lines from 630 to 636, also line 651 + line 690-691  were added ( inorder to solve the design problem(width and position) of datepicker with rtl direction )
 * Line 693 was commented because it was set to solve the broken design of the arabic datepicker but it affected the picker => when closing the datepicker,it is not removed from the html and thus it is not re opening again
 */
                        ...
                        place: function() {
                            ...
                            if (this.o.rtl) {
                                ...
                                this.picker.css({
                                    top: top,
                                    right: right,
                                    left: "auto", //fixing date picker position in rtl
                                    zIndex: zIndex
                                });
                            } else {
                                this.picker.css({
