...
(function(a) {
	...
	function e(b, e) {
		...
		d || (d = f), h.length > 1 && (h = a(e.items, b)), e.size > 1 && (e.circular = !1), a.extend(f, {getConf: function() {
				...
				var n = j ? {top: -l.position().top} : {left: (-l.position().left+f.getItems().first().position().left+2)};
		...
		var _vpw = f.getItems().parent().parent().width(), _nsl = f.getItems().last().position().left + (f.getItems().last().width()*1.5);
		o.toggleClass(e.disabledClass, (f.getItems().eq(0).position().left+_vpw)>_nsl)
		e.circular || (f.onBeforeSeek(function(a, b) {
			setTimeout(function() {
				a.isDefaultPrevented() || (n.toggleClass(e.disabledClass, b <= 0), o.toggleClass(e.disabledClass, (f.getItems().eq(b).position().left+_vpw)>_nsl))
			}, 1)
