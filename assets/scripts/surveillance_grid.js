...
function gridInitialization() {
    ...
    if (jQuery('#display-columns').val()) {
        ...
        tableColumns.push({field: 'id', title: ' ', filterable: false, sortable: false, template: '<input type="checkbox" name="caseIds[]" title="'+_lang.archiveCheckboxTitle+'" id="caseId_#= id #" value="#= id #" onchange="enableDisable_tooltips(this);" />' +
                    ...
                    '<a class="dropdown-item" href="' + getBaseURL() + 'cases/complaint_details/#= id #">' + _lang.viewEdit + '</a>' +
                    '<a class="dropdown-item" href="' + getBaseURL() + 'cases/complaint_details/#= id #">' + _lang.convertToProsecution + '</a>' +
        ...
        jQuery.each(columnsArray, function (i, item) {
            if (item === 'id') {
                array_push = {field: item, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, filterable: false, title: _lang.criminalCaseSeriaNo, template: '<a href="' + getBaseURL() + 'cases/complaint_details/#= id #">#= caseID #</a>', width: '120px'};
                ...
                array_push = {field: item, title: _lang.subject_Case, template: '<a href="' + getBaseURL() + 'cases/complaint_details/#= id #"><bdi>#=  replaceHtmlCharacter(addslashes(subject)).replace("\\\\\\\'", "\\\'") #</bdi></a><i class="iconLegal iconPrivacy#=private#"></i>', width: '220px'};
            } else if (item === 'latest_development') {
                array_push = {field: item, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, title: _lang.otherPointsOfPresence, template: '#= getLatestDevelopment(latest_development) #', width: '350px'};
            } else if (item === 'assignee') {
                array_push = {field: item, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, title: _lang.investigationOfficer, template: '#= (assignee!=null && userStatus=="Inactive")? assignee+" ("+_lang.custom[userStatus]+")":((assignee!=null)?assignee:"") #', width: '192px'};
                ...
                array_push = {field: item, title: _lang.findings, template: '#= (statusComments!=null&&statusComments!="") ? statusComments.substring(0,40)+"..." : ""#', width: '320px'};
            }
                ...
                array_push = {encoded: false, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, field: item, title: _lang.operatorName, width: '252px', template: "#= (opponentNames == null) ? '' : opponentNames #"};
            }
                ...
                array_push = {field: item, title: _lang.categoryOfOperations, width: '170px'};
            }
                ...
                array_push = {field: item, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, title: _lang.actionTaken, width: '182px'};
            }
