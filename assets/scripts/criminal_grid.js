...
function gridInitialization() {
    ...
    if (jQuery('#display-columns').val()) {
        ...
        jQuery.each(columnsArray, function (i, item) {
            if (item === 'id') {
                array_push = {field: item, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, filterable: false, title: _lang.criminalCaseSeriaNo, template: '<a href="' + getBaseURL() + 'cases/edit/#= id #">#= caseID #</a>', width: '120px'};
           ...
           /* else if (item === 'caseClientPosition') {
                ...
                array_push = {encoded: false, sortable: !sqlsrv2008, headerAttributes: {"col-header-placeholder": sqlsrv2008 ? _lang.columnDisabledSorting : ''}, field: item, title: _lang.opponentsOfInterest, width: '192px', template: "#= (opponentNames == null) ? '' : opponentNames #"};
            }
