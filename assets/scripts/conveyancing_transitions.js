...
function transitionFormSubmit() {
    ...
    jQuery.ajax({
        url: getBaseURL() + 'opinion_workflows/' + (id ? 'edit_transition/' + id : 'add_transition'),
        type: 'POST',
        dataType: "json",
        data: formData,
        ...
        success: function (response) {
            ...
            if (response.result) {
                ...
                window.location = getBaseURL() + 'opinion_workflows/index/' + jQuery('#workflow-id', container).val();
            } else {
