...
import './OpponentLawyersEditForm.scss';
...
export default React.memo((props) => {
    const formId = "litigation-case-stage-opponent-lawyers-edit-form";
    ...
    const [formData, setFormData] = useState({
        ...
        contact_role: props?.item?.contact_role ?? '',
        contact_role_name: props?.item?.contact_role_name ?? '',
    ...
    const [listValues, listValuesDispatcher] = useState({
        contact: {
            title: props?.item?.contact_name ?? '',
            value: props?.item?.contact ?? ''
        },
        contact_role: {
            title: props?.item?.contact_role_name ?? '',
            value: props?.item?.contact_role ?? ''
        }
    });
    ...
    const handleLawyerContactChange = (state, stateValue, defaultValues, multipleSelection, defaultValuesWithMultipleSelection, changeDefaultValues) => {
    ...
    const handleLawyerContactRoleChange = (state, stateValue, defaultValues, multipleSelection, defaultValuesWithMultipleSelection, changeDefaultValues) => {
        setFormData(prevState => ({
            ...prevState,
                            ...
                            >
                                ...
                                >
                                    <APAutocompleteList
                                        ...
                                        valueKey="value"
                                        onChange={handleLawyerContactChange}
                                    ...
                                    <APAutocompleteList
                                        ...
                                        valueKey="value"
                                        onChange={handleLawyerContactRoleChange}
                                    />
                                    <APTextFieldInput
                                        label={t("comments")}
                                        stateKey="comments"
                                    ...
                                    />
                                    {
                                        showValidationMessage ?
                                            (
                                                ...
                                                >
                                                    {t("opponent_lawyer_already_exists")}
                                                </Typography>
                                            )
                                            :
                                            null
