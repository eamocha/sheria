 <style>
        ...
        .step-header .collapse-toggle-icon {
            margin-left: 15px;
            /* No transform here, handled by JS class swap */
        }
        .step-footer {
            display: flex;
...
<script>
    ...
    function renderWorkflowConfig() {
        ...
        jQuery('[data-toggle="dropdown"]').dropdown(); // Use $ explicitly
        jQuery('[data-toggle="collapse"]').each(function() { // Use $ explicitly
            var $this = jQuery(this); // Use $ explicitly
            var target = $this.data('target');
            var $target = jQuery(target); // Use $ explicitly
            var $icon = $this.find('.collapse-toggle-icon'); // Use $ explicitly
            ...
            $target.off('show.bs.collapse hide.bs.collapse').on('show.bs.collapse', function () {
                $icon.removeClass('fa-chevron-right').addClass('fa-chevron-down');
