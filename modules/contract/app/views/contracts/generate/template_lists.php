...
<div class="col-md-12 p-0 m-0 form-group row margin-bottom-10">
    <div class="col-md-12 p-0 m-0 orm-group row margin-bottom-10">
           <label class="col-form-label text-right required"><?php echo $this->lang->line("type");?></label>
       </div>
       <div class="form-group row col-md-12 p-0 m-0">
           <?php echo form_input(["id" => "category", "name"=>"category","class" => "form-control ", "value" => "contract", "type"=>"hidden"]); ?>
