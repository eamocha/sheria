                    ...
                    echo form_input(["name" => "id", "value" => $id, "id" => "id", "type" => "hidden"]);?>
                        <div class="col-md-12 no-padding">
                            <div class="row m-0 form-group col-md-12 no-padding">
                                <label class="control-label "><i class="fa-solid fa-paperclip"></i><?php echo $this->lang->line("attach_signed_opinion_file");?></label>
                                <div class="col-md-6">
                                    <input type='file' name='file' id='file' class='margin-top' >
                                </div>
