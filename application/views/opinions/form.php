...
?><div class="primary-style">
    <div class="modal fade modal-container modal-resizable" id="opinion-modal">
        <div class="modal-dialog opinion-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="opinion-modal-wrapper">
                    <div id="opinionContainer" class="col-md-12 m-0 p-0 padding-10"><?php
                        ...
                        echo form_input(["name" => "assignment_id", "id" => "assignment-id", "value" => $assignments["id"]??=null, "type" => "hidden"]);
                        echo form_input(["name" => "user_relation", "id" => "user-relation", "value" => $assignments["user"]["id"]??=null, "type" => "hidden"]);
                        ?>
                        <div class="col-md-12 p-0" id="required-fields-opinion-demo">
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10">
                                    <label class="control-label required col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("title");?></label>
                                    <div class="col-md-8 pr-0 row m-0">
                                        <div class="col-md-11 p-0 col-xs-10"><?php echo form_input(["name" => "title", "value" => isset($opinionData["title"]) ? $opinionData["title"] : NULL, "id" => "title", "class" => "m-0 form-control", "autofocus" => "autofocus"]);?> </div>
                            ...
                            <div class="col-md-12 p-0 d-none">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="type-wrapper">
                                    <label class="control-label col-md-3 pr-0 required col-xs-5 restriction-tooltip"><?php echo $this->lang->line("opinion_type");?></label>
                                    <div class="col-md-8 pr-0 row m-0">
                                        <div class="col-md-11 p-0 col-xs-10"><?php
                                            echo form_dropdown(
                                                "opinion_type_id",
                                                $type,
                                                $opinionData["opinion_type_id"] ? $opinionData["opinion_type_id"] : $system_preferences["opinionTypeId"],
                                                'id="type" class="form-control select-picker" data-live-search="true" data-field="administration-opinion_types" data-size="' . $this->session->userdata("max_drop_down_length") . '"'
                                            );
                                            ?>
                                        </div>
                                        <div class="col-md-1 p-0 col-xs-1">
                                        <a id="quickAddButton" href="javascript:;" onclick="quickAdministrationDialog('opinion_types', jQuery('#opinion-form', '#opinion-dialog'), true);" class="btn btn-link padding-all-8"><i class="fa-solid fa-square-plus p-1 font-18"> </i></a>
                                         </div>
                            ...
                            <div class="col-md-12 p-0">
                                <div id="custom_fields_div"><?php $this->load->view("custom_fields/dialog_form_custom_field_template", ["custom_fields" => $custom_fields]);?>              </div>
                            </div>
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="background_info-wrapper">
                                    <label class="control-label col-md-3 pr-0 col-xs-5 restriction-tooltip" ><?php echo $this->lang->line("background_info");?></label>
                                    <div class="col-md-8 pr-0 col-xs-11"><?php echo form_textarea("background_info", $opinionData["background_info"], ["id" => "background_info", "class" => "form-control", "rows" => "5", "dir" => "auto"]);?>
                                        <div data-field="background_info" class="inline-error d-none"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="detailed_info-wrapper">
                                    <label class="control-label col-md-3 pr-0 col-xs-5 restriction-tooltip" ><?php echo $this->lang->line("detailed_info");?></label>
                                    <div class="col-md-8 pr-0 col-xs-11"><?php echo form_textarea("detailed_info", $opinionData["detailed_info"], ["id" => "detailed_info", "class" => "form-control", "rows" => "5", "dir" => "auto"]);?>
                            ...
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="legal_question-wrapper">
                                    <label class="control-label col-md-3 pr-0 col-xs-5 restriction-tooltip" ><?php echo $this->lang->line("legal_question");?></label>
                                    <div class="col-md-8 pr-0 col-xs-11"><?php echo form_textarea("legal_question", $opinionData["legal_question"], ["id" => "legal_question", "class" => "form-control", "rows" => "5", "dir" => "auto"]);?>
                            ...
                            <div class="col-md-12 p-0 assignee-container <?php echo !isset($assignments["visible_assignee"]) || $assignments["visible_assignee"] == 1 ? "" : "d-none";?>">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="assignee-wrapper">
                                    <label class="control-label col-md-3 pr-0 required col-xs-5 restriction-tooltip"  id="assignedToLabelId"><?php echo $this->lang->line("assigned_to");?> </label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                                             <div class="input-group col-md-12 p-0 users-lookup-container mb-3" id="assigne-to-id-wrapper"><?php echo form_input(["name" => "assigned_to", "id" => "assignedToId", "value" => $cloned_assignee ?? ($opinionData["assigned_to"] ?: $assignments["user"]["id"]), "type" => "hidden"]);
                                             echo form_input(["name" => "assignedToLookUp", "id" => "assignedToLookUp", "value" => $cloned_assignee_name ?? ($opinionData["assignee_status"] == "Inactive" ? $opinionData["assignee_fullname"] . "(" . $this->lang->line("Inactive") . ")" : $opinionData["assignee_fullname"]), "class" => "form-control users-lookup", "title" => $this->lang->line("start_typing")]);?>
                                        ...
                                        <span class="assign-to-me-link-id-wrapper">
                                            <a href="javascript:;" id="assignToMeLinkId" onclick="addMe({hidden_id: jQuery('#assignedToId', '#opinion-form'), lookup_field: jQuery('#assignedToLookUp', '#opinion-form'), lookup_container: jQuery('.assignee-container', '#opinion-form'), container: jQuery('#opinion-form')});"><?php echo $this->lang->line("assign_to_me");?></a>
                                        </span>
                            ...
                            <div class="col-md-12 p-0" id="contributors-container">
                                <div class="form-group p-0 row">
                                    <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("copy_to");?></label>
                                    <div class="col-md-8 pr-0 col-xs-10 users-lookup-container">
                                        <div class="input-group col-md-12 p-0 margin-bottom-5"><?php echo form_input("contributors_lookup", "", 'id="contributors-lookup" class="form-control users-lookup"');?>
                                        ...
                                        <div id="selected-contributors" class="height-auto m-0">
                                            <?php if (!empty($contributors)) {
                                                ...
                                                foreach ($contributors as $key => $value) { ?>
                                                    <div class="row multi-option-selected-items m-0" id="<?php echo $select_options_name;  echo $value["id"];?>"><span id="<?php   echo $value["id"];?>"><?php  echo $value["status"] === "Inactive" ? $value["name"] . "(" . $this->lang->line("Inactive") . ")" : $value["name"]; ?></span>
                            ...
                            <div class="col-md-12 p-0 reporter-container">
                                <div class="form-group col-md-12 p-0 reporter row m-0 mb-10" id="reporter-wrapper">
                                    <label class="control-label col-md-3 pr-0 required col-xs-5 restriction-tooltip"  id="reporterLabelId"><?php echo $this->lang->line("requested_by");?></label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                                        <div class="input-group col-md-12 p-0 users-lookup-container">
                                            <?php echo form_input(["name" => "reporter", "id" => "reporter-id", "value" => $opinionData["id"] ? $opinionData["reporter"] : $toMeId, "type" => "hidden"]);
                                            echo form_input(["name" => "reporterLookUp", "id" => "reporterLookUp", "value" => $opinionData["id"] ? $opinionData["reporter_status"] == "Inactive" ? $opinionData["reporter_fullname"] . "(" . $this->lang->line("Inactive") . ")" : $opinionData["reporter_fullname"] : $toMeFullName, "class" => "form-control users-lookup", "title" => $this->lang->line("start_typing")]);
                                            ?>
                                            <span class="input-group-addon bs-caret users-lookup-icon" onclick="jQuery('#reporterLookUp').focus();"><span class="caret"></span></span>
                                        </div>
                            ...
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="priority-wrapper">
                                    <label class="control-label col-md-3 pr-0 required col-xs-5"><?php echo $this->lang->line("priority");?></label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                                        <div class="col-md-12 p-0">
                                            <select name="priority" class="form-control select-picker" id="priority" data-live-search="true"><?php $selected = "";
                                ...
                                <div class="col-md-12 form-group p-0 row m-0 mb-10">
                                    ...
                                    <div class="col-md-8 pr-0 col-xs-10" id="due-date-wrapper">
                                        <div class="row m-0">
                                            ...
                                            </div><?php if ($system_preferences["hijriCalendarConverter"]) {?>
                                            <div class="col-md-3 mt-3 col-xs-2 visualize-hijri-date">
                                                <span class="assign-to-me-link-id-wrapper">
                                                    <a href="javascript:;" id="date-conversion" onclick="HijriConverter(jQuery('#form-due-date', '#opinion-dialog'));" title="<?php    echo $this->lang->line("hijri_date_converter");?>">
                                        ...
                                        <div class="row col-md-10 <?php echo $opinionData["due_date"] && !$notify_before ? "" : "d-none";?>" id="notify-me-before-link">
                                            <span class="assign-to-me-link-id-wrapper"> <a href="javascript:;" id="notify-me-link" onclick="notifyMeBefore(jQuery('#opinion-form'));"><?php echo $this->lang->line("notify_me_before");?></a></span>
                                        </div>
<!--                                        <div data-field="due_date" class="inline-error d-none"></div>-->
                            ...
                            <div class="col-md-12 p-0 d-none mb-10" id="notify-me-before-container">
                                <div class="form-group col-md-12 p-0 row m-0">
                                    ...
                                    <div class="col-md-8 d-flex justify-content-between col-xs-10" id="notify-me-before"><?php echo form_input(["name" => "notify_me_before[id]", "value" => $notify_before["id"]??"", "disabled" => true, "type" => "hidden"]);
                                    ...
                                    ?>
                                        <label class="control-label"><?php echo $this->lang->line("reminder_by");?></label><?php echo form_dropdown("notify_me_before[type]", $notify_me_before_types, $notify_before["type"]??"", 'class="form-control select-picker" id="notify-me-before-type" disabled"');?>
                        ...
                        <div class="d-none container-hidden-fields">
                            ...
                            <div class="col-md-12 p-0 related-case-container core-access"><?php echo form_input(["name" => "legal_case_id", "id" => "caseLookupId", "value" => $opinionData["legal_case_id"], "data-field" => "case_id", "type" => "hidden"]);?>
                                <div class="form-group col-md-12 p-0 row m-0">
                                    ...
                                    <div id="case-subject" class="help-inline col-md-1 p-0 <?php    echo $opinionData["legal_case_id"] ? "" : "d-none";?>" >
                                        ...
                                        echo $opinionData["legal_case_id"];?>">   <i class="purple_color  <?php    echo $this->is_auth->is_layout_rtl() ? "fa-solid fa-arrow-left" : "fa-solid fa-arrow-right";?>"> </i>
                                        </a>
                                        </div><?php } ?>
                                    <div class="col-md-3 pr-0 col-xs-2" >&nbsp;</div>
                                    <div class="col-md-8 pr-0 col-xs-10">
                            ...
                            <div class="col-md-12 p-0 related-contract-container contract-access">
                                <div class="form-group col-md-12 p-0 row m-0">
                                    <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("related_contract");?>  </label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                            ...
                            <div id="stage-div"><?php echo isset($litigation_stage_html) ? $litigation_stage_html : "";?></div>

                            <div class="col-md-12 p-0 d-none">
                                <div class="form-group p-0 row ">
                                    <label class="control-label col-md-3 pr-0 estimated_effort col-xs-5" title="<?php echo $this->lang->line("estimated_effort");?>"><?php echo $this->lang->line("est_effort");?></label>
                                    <div class="col-md-8  d-flex pr-0 col-xs-10">
                                        <div class="col-md-8 pl-0"><?php echo form_input(["name" => "estimated_effort", "value" => $opinionData["estimated_effort"], "id" => "estimatedEffortHour", "class" => "m-0 form-control", "onblur" => "convertMinsToHrsMins(jQuery(this));"]);?></div>
                                    ...
                                    </div><?php if ($opinionData["id"] && isset($opinionData["effectiveEffort"]) && "" != $opinionData["effectiveEffort"]) {?>
                                    <div class="col-md-12 p-0">
                                        <div class="col-md-3 pr-0">&nbsp;</div>
                                        <div class="col-md-8 pr-0">
                                            <span class="eff-effort"><?php  echo $this->lang->line("effectiveEffort");?>: <?php echo $this->timemask->timeToHumanReadable($opinionData["effectiveEffort"]);
                                                $caseIdFilter = $opinionData["legal_case_id"] ? $opinionData["legal_case_id"] : 0;?>
                                                <a href="<?php echo site_url("time_tracking/my_time_logs/" . $caseIdFilter . "/" . $opinionData["id"]);?>" target="_blank" class="btn btn-default btn-link font-12">
                                                    <?php echo $this->lang->line("show_details"); ?></a>
                                            </span>
                                        </div>
                                    </div><?php }?>
                                </div>
                             ...
                             <div class="col-md-12 p-0 d-none" >
                                <div class=" form-group p-0 row mb-10">
                                    <label class="control-label pr-0 col-md-3 col-xs-5"><?php echo $this->lang->line("location");?></label>
                                    <div class="col-md-8 p-0 d-flex col-xs-10">
                                        <div class="col-md-11">
                                            <?php echo form_input(["name" => "location", "id" => "location", "class" => " form-control  lookup", "data-field" => "administration-opinion_locations", "title" => $this->lang->line("start_typing"), "value" => $opinionData["location"]]);?>
                                        </div>
                                        <div class="col-md-1 p-0 col-xs-1">
                                    ...
                                    <div class="col-md-12 p-0 row m-0d-none">
                            ...
                            <div class="col-md-12 p-0 users-lookup-container">
                                <div class="form-group p-0 row m-0">
                                    ...
                                    <div class="col-md-8 p-0 col-xs-10">
                                        <div class="checkbox" >
                                            <label><?php echo form_checkbox("private", "yes", $opinionData["private"] == "yes", 'id="private" onclick="enableDisableOpinionUsersLookup()"');
                                            echo $this->lang->line("set_as_private");?>
                                            </label>
                                        </div>
                                        <div class="d-none opinion-users-container margin-top-5">
                                            <label id="opinionUsersLabelId"><?php echo $this->lang->line("shared_with");?></label>
                                            <div class="margin-bottom"><?php echo form_input(["id" => "lookupOpinionUsers", "class" => "form-control lookup", "title" => $this->lang->line("start_typing")]);?>                                        </div>
                                            <div id="selected_opinion_users" class="row height-99 m-0">
                                                <?php if (!empty($opinionUsers)) {    $select_options_name = "Opinion_Users";
                                                foreach ($opinionUsers as $user) {?>
                                                <div class="row multi-option-selected-items m-0" id="<?php echo $select_options_name; echo $user["id"];?>">
                                                    <span id="<?php  echo $user["id"];?>"><?php   echo $user["status"] === "Inactive" ? $user["name"] . "(" . $this->lang->line("Inactive") . ")" : $user["name"];?>                                              </span>
                                                    <?php echo form_input(["value" => $user["id"], "name" => $select_options_name . "[]", "type" => "hidden"]);?>
                            ...
                            <div class="p-0 row m-0" id="attachments-container">
                                ...
                                <div id="opinion-attachments" class="col-md-8 pr-0 col-xs-10 mb-10">
                                    ...
                                    <?php    echo form_input(["name" => "opinion_attachments[]", "value" => "opinion_attachment_0", "type" => "hidden"]);?>
                                </div>
                                <div class="col-md-12">
                                    <div class="offset-md-3 pr-0 col-xs-5">
                                        <div class="col-md-7 col-xs-10">
                                            <div data-field="file"class="inline-error d-none"></div>
                                            <a href="javascript:;" onclick="dialogObjectAttachFile('opinion', jQuery('#opinion-dialog'))" class="btn-link"><?php    echo $this->lang->line("add_more");?></a>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer justify-content-between">
                    <?php $this->load->view("templates/send_email_option_template", ["container" => "#opinionContainer", "hide_show_notification" => $hide_show_notification]);?>
                    <div>
                        <span class="loader-submit"></span>
                        <div class="btn-group">
                            <button type="button" class="btn btn-save btn-add-dropdown modal-save-btn" id="save-opinion-btn"><?php echo $this->lang->line("submit");?></button>
                            <?php if (!$opinionData["id"]) {    ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:;" onclick="cloneDialog(jQuery('#opinion-dialog'), opinionFormSubmit);"><?php     echo $this->lang->line("create_another");  ?></a>
                            </div><?php
                            }?>
                        </div>
