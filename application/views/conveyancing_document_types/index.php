    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo site_url("conveyancing_document_types/add"); ?>">
            ...
            <div class="col-md-12 form-group row" id="pagination">
                <div class="col-md-6 no-padding col-xs-12">
                    <h4>
                        ...
                        <?php echo $this->conveyancing_document_type->get("paginationTotalRows"); ?>
                    </h4>
                </div>
                <?php
                $links = $this->conveyancing_document_type->get("paginationLinks");
                if (!empty($links)) {
                ?>
                ...
                <div class="col-md-12 form-group">
                    <div class="dropdown more pull-right margin-right10">
                        ...
                        <div aria-labelledby="dLabel" role="menu" class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?php echo site_url("export/conveyancing_document_types"); ?>">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php foreach ($records as $record) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url("conveyancing_document_types/edit/" . $record["id"]); ?>">
                                        <i class="fa fa-edit fa-lg"></i>
                                    </a>&nbsp;
                                </td>
                                <td>
                                    <a href="<?php echo site_url("conveyancing_document_types/delete/" . $record["id"]); ?>"
