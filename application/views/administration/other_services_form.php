              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body"><!-- /.modal-body -->
                      ...
                      <div class="col-md-12 form-group row p-0">
                          ...
                          <div class="col-md-8  col-xs-10"><?php echo form_dropdown($applies_to_field["name"], ["opinion"=>"Opinion","both"=>"Both","conveyancing"=>"Conveyancing"],"Contract", 'class="form-control"'); ?>
