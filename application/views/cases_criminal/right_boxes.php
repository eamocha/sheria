...
<div class="primary-style col-md-3 right-side-section no-padding-left">
    <div class="right-box-container">
        ...
        <div class="right-box-body box-shadow_container padding-10 mb-20">
            ...
            <div class="form-group no-padding min-height-35 flex-item-box" id="reason_for_reassignment_controls">
                <label class="control-label no-padding-right no-padding padding-top-10 min-width-100  trim-width-33-per">
                    <span class="control-label"><?php echo $this->lang->line("reassignment_reason"); ?></span>
                </label>
                <div class="no-padding float-right flex-grow width-50-per">
                    <?php
                  $data = array( 'name' => 'reason_for_reassignment', 'id' => 'reason_for_reassignment', 'placeholder' => 'Give Reason for re-assigning the case', 'class' => 'form-control' );
            ...
            <div class="col-md-12 no-padding">
                ...
                <div id="selected-watchers"
                    ...
                    <div class="flex-item-box row multi-option-selected-items no-margin w-100 height-30px"
                        ...
                        <a href="javascript:;"
                           class="btn btn-default btn-sm btn-link pull-right remove-button flex-end-item" tabindex="-1"
                           onClick="removeBoxElement(jQuery(this.parentNode),'#selected-watchers','watcher-lookup-container','#ticket-modifiable-fields');">
                            <i class="fa-solid fa-xmark"></i>
                        </a>
                        </div><?php }
            ...
            <div class="form-group no-padding  d-none" id="notify-me-before-container">
                <div class="flex-item-box form-group no-padding min-height-35">
                    ...
                    <div class="no-padding float-right flex-grow" id="notify-me-before">
                        <?php
                        echo form_input(["name" => "notify_me_before[id]", "form" => "legalCaseAddForm", "value" => $notify_before["id"] ? $notify_before["id"] : "", "disabled" => true, "type" => "hidden"]);
                        echo form_input(["name" => "notify_me_before[time]", "form" => "legalCaseAddForm", "class" => "form-control", "value" => $notify_before["time"] ? $notify_before["time"] : $systemPreferences["reminderIntervalDate"], "id" => "notify-me-before-time", "disabled" => true, "data-validation-engine" => "validate[required]"]);
