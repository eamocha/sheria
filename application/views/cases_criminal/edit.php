...
?>
                                            ...
                                            <div class="row col-md-12 no-padding no-margin">
                                             ...
                                             <div class="row col-md-12 no-padding no-margin">
                                                <div class="form-group col-md-6 no-padding row no-margin">
                                                    ...
                                                    $case_scenario_type = $legalCase["category"] == "Litigation" ? "litigation" : "corporate";
                                                    ?>
                                                    <div class="col-md-4 no-padding">
                                                        <label class="form-label required">  <?php echo $this->lang->line("case_type_case");?> </label>
                                             ...
                                             <div class="row col-md-12 no-padding no-margin " id="otherRefNumbers">
                                                 <div class="form-group col-md-6 no-padding-left row no-margin">
                                                     <label class="form-label ">CF Number</label>
                                             ...
                                             <div class="row col-md-12 no-padding no-margin d-none" id="workflow-status-container-design">
                                                    ...
                                                    <div class="row col-md-12 no-padding no-margin row no-margin">
                                                        ...
                                                        $case_scenario_general = "scenario_case_stages_";?>
                                                            <label class="control-label col-md-4 no-padding"><?php echo $this->lang->line("court");?>
                                             ...
                                             <div class="row col-md-12 no-padding no-margin row no-margin">
                                                 <div class="form-group col-md-6 no-padding row no-margin">
                                                     <label class="control-label col-md-4 no-padding">
                                                         ...
                                                         $companyLinkHref = site_url("companies/tab_company/" . $clientData["member_id"]);
                                                         $clientLinkHref = $clientData["type"] == "Company" ? $companyLinkHref : site_url("contacts/edit/" . $clientData["member_id"]);
                                                         ?>
                                                 ...
                                                 <div class="row m-0 col-md-12 no-padding opponent-div" id="opponent-<?php echo $count;?>">
                                                     <div class="row m-0 form-group col-md-6 no-padding">
                                                         ...
                                                         <div class="row m-0 col-md-8 no-padding">
                                                             ...
                                                             <div class="col-md-9">
                                                                 <?php
                                                                 echo form_input(["name" => "opponent_member_id[]", "id" => "opponent-member-id", "value" => $opponentData["opponent_member_id"], "type" => "hidden"]);
                                    ...
                                    <div class="box-section row margin-bottom-15" id="court_activities_div">
                                        <h2 class="box-title box-shadow_container ">
                                            ...
                                            <span class="text-with-hint tooltip-title" title="<?php echo $legalCase["category"] == "Litigation" ? $this->lang->line("litigation_activities_helper") : $this->lang->line("criminal_activities_helper");?>">
                                                <?php echo $this->lang->line("enforcement_actions");?>
                                            </span>
                                        </h2>
   ...
   -->
                                                <a class="cursor-pointer-click btn btn-primary" ><?php echo $this->lang->line("record_enforcement_action")?></a>
                                    ...
                                    <div class="box-section row margin-bottom-15" id="outsourcing_to_lawyers_div">
                                        <h2 class="box-title box-shadow_container ">
                                            ...
                                            <span class="text-with-hint tooltip-title" title="<?php echo $legalCase["category"] == "Litigation" ? $this->lang->line("litigation_outsourcing_to_helper") : $this->lang->line("matter_outsourcing_to_helper");?>">
                                                <?php echo $this->lang->line("witness_and_statements");?>
                                            </span>
                                        </h2>
                                        <div class="col-md-12 box-shadow_container padding-15 main-grid-container">
                                            <div class="col-md-12 no-padding grid-section">
                                    ...
                                    <div class="box-section row margin-bottom-15" id="related_contributors_div">
                                        <h2 class="box-title box-shadow_container ">
                                            ...
                                            <span class="text-with-hint tooltip-title" title="<?php echo $legalCase["category"] == "Litigation" ? $this->lang->line("litigation_related_contributors_helper") : $this->lang->line("matter_related_contributors_helper");?>">
                                                <?php echo $this->lang->line("exhibits_list");?>
                                            </span>
                                        </h2>
                                        <div class="col-md-12 box-shadow_container padding-15 main-grid-container">
                                            <div class="col-md-12 no-padding grid-section">
