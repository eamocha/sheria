    ...
    <div class="modal fade modal-container modal-resizable" id="opinion-modal">
        <div class="modal-dialog opinion-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div id="opinionContainer" class="col-md-12 m-0 p-0 padding-10"><?php
                        ...
                        <div class="col-md-12 p-0" id="required-fields-opinion-demo">
                            ...
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="type-wrapper">
                                    ...
                                    <div class="col-md-8 pr-0 row m-0">
                                        <div class="col-md-11 p-0 col-xs-10"><?php echo form_dropdown("opinion_type_id", $type, $opinionData["opinion_type_id"] ? $opinionData["opinion_type_id"] : $system_preferences["opinionTypeId"], 'id="type" class="form-control select-picker" data-live-search="true" data-field="administration-opinion_types" data-size=" . $this->session->userdata("max_drop_down_length") . "\"'); ?></div>
                            ...
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 row m-0 mb-10" id="legal_question-wrapper">
                                    ...
                                    <div class="col-md-8 pr-0 col-xs-11"><?php echo form_textarea("legal_question", $opinionData["detailed_info"], ["id" => "legal_question", "class" => "form-control", "rows" => "5", "dir" => "auto"]);?>
                        ...
                        <div class="d-none container-hidden-fields">
                            ...
                            <div class="col-md-12 p-0" id="contributors-container">
                                <div class="form-group p-0 row">
                                    <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("contributors");?></label>
                             ...
                             <div class="col-md-12 p-0 d-none" >
                                <div class=" form-group p-0 row mb-10">
                                    ...
                                    <div class="col-md-8 p-0 d-flex col-xs-10">
                                        <div class="col-md-11"><?php echo form_input(["name" => "location", "id" => "location", "class" => " form-control  lookup", "data-field" => "administration-opinion_locations", "title" => $this->lang->line("start_typing"), "value" => $opinionData["location"]]);?>
                                        </div>
                                        <div class="col-md-1 p-0 col-xs-1">
                ...
                <div class="modal-footer justify-content-between"><?php $this->load->view("templates/send_email_option_template", ["container" => "#opinionContainer", "hide_show_notification" => $hide_show_notification]);?>
                    <div>
                        <span class="loader-submit"></span>
                        <div class="btn-group">
                            <button type="button" class="btn btn-save btn-add-dropdown modal-save-btn" id="save-opinion-btn"><?php echo $this->lang->line("save");?></button>
                            <?php if (!$opinionData["id"]) {    ?>
