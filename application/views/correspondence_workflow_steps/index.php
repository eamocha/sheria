    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo $this->lang->line("correspondence_workflow_steps"); ?></li>
                <li class="breadcrumb-item">
                    <a href="<?php echo site_url("correspondence_workflow_steps/add/".$type_id); ?>">
        ...
        <div class="col-md-12 no-padding">
            <div class="col-md-12 form-group row" id="pagination">
                ...
                <?php
                $links = $this->correspondence_workflow_step->get("paginationLinks");
                if (!empty($links)) {
                ?>
                ...
                <div class="col-md-12 form-group">
                    <div class="dropdown more pull-right margin-right10">
                        ...
                        <div aria-labelledby="dLabel" role="menu" class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?php echo site_url("export/correspondence_workflow_steps"); ?>">
                        ...
                        <?php foreach ($records as $record) { ?>
                            <tr>
                                <td><?php echo $record["name"]; ?>&nbsp;</td>
                                  <td><?php echo $record["sequence_order"]; ?>&nbsp;</td>
                                    <td><?php echo $record["comment"]; ?>&nbsp;</td>
                                <td>
                                    <a href="<?php echo site_url("correspondence_workflow_steps/edit/" . $record["id"]); ?>">
                                ...
                                <td>
                                    <a href="javascript:;"
                                       onclick="return confirm(_lang.confirmationDeleteSelectedRecord) ?
                                               document.location = '<?php echo site_url("correspondence_workflow_steps/delete/" . $record["id"]); ?>' :
                                               false;">
