<div class="modal fade modal-container modal-resizable" id="docsModal" tabindex="-1" role="dialog" aria-labelledby="docsModalLabel" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="upload-form-container" class="col-md-12 no-margin p-0 padding-10">
                    ...
                    <div class="col-md-12 p-0 form-group row margin-bottom-10">
                        ...
                        <div class="col-md-9 pr-0 col-xs-12">
                            <div class="col-md-8 p-0 col-xs-10">
                                <?php echo form_dropdown("document_type_id", $documentTypes, "", 'id="document_type_id" class="form-control select-picker"'); ?>
                            </div>
                    ...
                    <div class="col-md-12 p-0 form-group row margin-bottom-10">
                        ...
                        <div class="col-md-9 pr-0 col-xs-12">
                            <div class="col-md-8 p-0 col-xs-10">
                                <?php echo form_dropdown("document_status_id", $documentStatuses, "", 'id="document_status_id" class="form-control select-picker"'); ?>
                            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-save modal-save-btn" id="form-submit">
