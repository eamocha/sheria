                            ...
                            <div class="col-md-12 no-padding matter">
                                ...
                                <div class="box-section row margin-bottom-15" id="personal_info_div">
                                    ...
                                    <div class="form-group col-md-12 no-padding">
                                        ...
                                        <!--- parties
                                       <div class="row col-md-12 no-padding no-margin"  id="casePartiesBox">
                                           <a class="btn btn-sm  text-primary pull right"                onclick="open_party_form(<?php echo $case_id ?>)"               title="Add New Party">
                                               <i class="fas fa-plus-square me-1"></i> Add Party            </a>
                                           <?php $opponents['parties']=$relatedOpponentData;
                                           $opponents['case_id']=$case_id;
                                           $this->load->view("cases/parties/view2", $opponents);   ?>
                                       </div>-->
                                        <div class="row col-md-12 no-padding no-margin row no-margin">
                                            ...
                                            <div class="form-group col-md-6 no-padding row no-margin">
                                                <label class="control-label col-md-4 no-padding">
                                                    ...
                                                    $ctype=$clientData["type"]??"";
                                                    $companyLinkHref = site_url("companies/tab_company/" . $clientData["member_id"]??=0);
                                                    $clientLinkHref = $ctype== "Company" ? $companyLinkHref : site_url("contacts/edit/" . $clientData["member_id"]??=0);
                                                    ?>
                                ...
                                <div class="box-section row margin-bottom-15" id="case_docs_summary_div">
                                    ...
                                    <div class="col-md-12 box-shadow_container padding-15 main-grid-container"  id="case-docs-summary-container">
                                        <div class="col-md-12 no-padding grid-section" id="case-docs-summary-dataGrid" data-field="<?php echo $case_id?>">
