            ...
            <div class="modal-content">
                ...
                <form id="partyForm" class="p-4">
                    ...
                    <div class="form-group">
                        ...
                        <select name="party_member_type" id="party-type" class="form-control select-picker" tabindex="-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="party_member_id" id="party-member-id" value="<?php echo $party_record["party_member_id"] ?? ""; ?>" />
                        <input type="text" name="partyLookup" id="party-lookup" class="form-control lookup" value="<?php echo $party_record["partyName"] ?? ""; ?>" class="form-control" title="<?php echo $this->lang->line("start_typing"); ?>" />
                    </div>
                    <div class="form-group">
                        ...
                        <?php echo form_dropdown("party_position", $party_positions, $partyData["party_position"] ?? "", 'id="party-position" class="form-control select-picker" data-live-search="true" data-field-id="administration-case_party_positions"'); ?>
                    </div>
