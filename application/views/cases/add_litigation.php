        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php  echo $this->lang->line("add_litigation_case");?></h4>
                ...
                <div class="modal-body" id="modal-body-add-litigation">
                    <div id="litigation-add-form-container" class="col-md-12 m-0 p-0 padding-10"><?php
                        ...
                        echo form_input(["id" => "action", "value" => "add_litigation", "type" => "hidden"]);
                        ...
                        <div class="col-md-12 p-0" id="required-fields-litigation-demo">
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-12 p-0 col-xs-12 row m-0 mb-10" id="required-fields-litigation-demo">
                                    <label class="control-label col-md-3 pr-0 required col-xs-5"><?php echo $this->lang->line("subject_Case");?></label>
                            ...
                            <div class="col-md-12 p-0 form-group row m-0 mb-10">
                                <label class="control-label col-md-3 pr-0 required col-xs-5"><?php echo $this->lang->line("case_type_case");?></label>
                            ...
                            <div class="form-group col-md-12 p-0 row m-0 mb-10" id="arrival-date-container">
                                <label class="control-label col-md-3 pr-0 col-xs-5 required"><?php echo $this->lang->line("arrival_date");?></label>
                        ...
                        <div class="col-md-12 p-0 row m-0 mb-10" id="optional-fields-litigation-demo">
                            <div class="form-group col-md-12 p-0 col-xs-12 row m-0 mb-10">
                                <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("description_Case"); ?>&nbsp; <span class="tooltip-title" title="<?php echo $this->lang->line("litigation_description_help");?>"><i class="fa-solid fa-circle-question purple_color"></i></span></label>
                                <div class="col-md-8 pr-0"><?php echo form_textarea(["name" => "description", "id" => "description", "class" => "form-control", "rows" => "5", "cols" => "0", "value" => $selected_values["container_common_fields"]["containerDescription"] ?? ""]);?>
                                    <div data-field="description" class="inline-error d-none"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-12 p-0 row m-0 mb-10">
                            <label class="control-label col-md-3 pr-0 col-xs-5 required"><?php echo $this->lang->line("client_name");?></label>
                            <div class="col-md-8 pr-0 col-xs-10">
                                <div class="col-md-12 p-0">
                        ...
                        <div class="col-md-12 form-group p-0 row m-0 mb-10">
                            ...
                            <div class="col-md-8 pr-0 col-xs-10">
                                <div class="col-md-12 p-0"><?php echo form_input(["name" => "contact_company_id", "id" => "contact-company-id", "value" => $selected_values["container_common_fields"]["client_data"]["member_id"] ??$defaultCompanyId, "type" => "hidden"]);?>
                                    <?php echo form_input(["name" => "clientLookup", "id" => "client-lookup", "value" => $selected_values["container_common_fields"]["client_data"]["name"] ?? $defaultCompanyName, "class" => "form-control lookup", "title" => $this->lang->line("start_typing")]);?>
                        ...
                        <div id="opponents-container"><?php echo form_input(["name" => "opponentsCount", "id" => "opponents-count", "value" => isset($selected_values["container_common_fields"]["opponent_count"]) && 0 < $selected_values["container_common_fields"]["opponent_count"] ? $selected_values["container_common_fields"]["opponent_count"] : "1", "type" => "hidden"]);?>
                            ...
                            <div class="opponent-div" id="opponent-<?php echo $count;?>">
                                <div class="col-md-12 p-0 form-group d-flex margin-bottom-10">
                                    <label class="control-label col-md-3 pr-0 col-xs-5 opponent-label"><?php echo $this->lang->line("opponent") . " (" . $count;?>)</label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                            ...
                            <div class="opponent-div" id="opponent-1">
                                <div class="col-md-12 p-0 d-flex form-group margin-bottom-10">
                                    <label class="control-label col-md-3 pr-0 col-xs-5 opponent-label"><?php echo $this->lang->line("opponent") . " (1)";?></label>
                                    <div class="col-md-8 pr-0 col-xs-10">
                                        <div class="col-md-12 p-0">
                                            <select name="opponent_member_type[]" id="opponent-member-type" class="form-control">
                        ...
                        <div class="form-group col-md-12 d-flex p-0" id="due-date-container">
                            <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("first_court_date");?>&nbsp; <span class="tooltip-title" title="<?php echo $this->lang->line("litigation_first_court_date_helper");?>"><i class="fa-solid fa-circle-question purple_color"></i></span></label>
                            <div class="col-md-8 pr-0 col-xs-10">
                                ...
                                <?php if ($systemPreferences["hijriCalendarConverter"]) {?>
                                <div class="col-md-3 p-0 col-xs-2 visualize-hijri-date"><a href="javascript:;" id="date-conversion" onclick="HijriConverter(jQuery('#due-date-add-new', '#litigation-dialog'));" title="<?php echo $this->lang->line("hijri_date_converter");?>" class="btn btn-link"><?php echo $this->lang->line("hijri");?></a></div>
                                <?php } ?>
                        ...
                        <div class="form-group col-md-12 d-flex p-0">
                            <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("litigation_case_court_activity_purpose");?></label>
                            <div class="col-md-8 pr-0 col-xs-10">
                                <div class="col-md-12 p-0"><?php echo form_input(["dir" => "auto", "name" => "fist_litigation_case_court_activity_purpose", "class" => "form-control", "value" => ""]);?> </div>
                                <div data-field="fist_litigation_case_court_activity_purpose" class="inline-error d-none"></div>
                            </div>
                        </div>
                        <div class="form-group col-md-12 d-flex p-0">
                            <label class="control-label col-md-3 pr-0 col-xs-5"><?php echo $this->lang->line("reference_case");?></label>
                            <div class="col-md-8 pr-0 col-xs-10">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn save-button modal-save-btn btn-info" id="case-submit"><?php  echo $this->lang->line("submit");?></button>
