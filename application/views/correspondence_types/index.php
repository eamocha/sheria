    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo $this->lang->line("correspondence_type"); ?></li>
                <li class="breadcrumb-item">
                    <a href="<?php echo site_url("correspondence_types/add"); ?>">
                        <?php echo $this->lang->line("add_correspondence_type"); ?>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-12 form-group row" id="pagination">
                <div class="col-md-6 no-padding col-xs-12">
                    <h4>
                        ...
                        <?php echo $this->correspondence_type->get("paginationTotalRows"); ?>
                    </h4>
                </div>
                <?php
                $links = $this->correspondence_type->get("paginationLinks");
                if (!empty($links)) {
                ?>
                ...
                <div class="col-md-12 form-group">
                    <div class="dropdown more pull-right margin-right10">
                        ...
                        <div aria-labelledby="dLabel" role="menu" class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?php echo site_url("export/correspondence_types"); ?>">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php foreach ($records as $record) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url("correspondence_workflow_steps/index/" . $record["id"]); ?>">
                                        <i class="fa fa-eye fa-lg"></i>
                                    </a>&nbsp;
                                </td>
                                <td>
                                    <a href="<?php echo site_url("correspondence_types/edit/" . $record["id"]); ?>">
                                ...
                                <td>
                                    <a href="javascript:;" 
                                       onclick="return confirm(_lang.confirmationDeleteSelectedRecord) ? 
                                               document.location = '<?php echo site_url("correspondence_types/delete/" . $record["id"]); ?>' : 
                                               false;">
