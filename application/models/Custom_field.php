...
class mysqli_Custom_field extends My_Model
{
    ...
    protected $models = [["table" => "companies", "controller" => "companies", "model" => "company"], ["table" => "contacts", "controller" => "contacts", "model" => "contact"], ["table" => "legal_cases", "controller" => "cases", "model" => "legal_case"], ["table" => "legal_cases", "controller" => "cases", "model" => "matter"],  ["table" => "legal_cases", "controller" => "cases", "model" => "criminal"],["table" => "legal_cases", "controller" => "cases", "model" => "litigation"], ["table" => "company_assets", "controller" => "companies", "model" => "company_asset"], ["table" => "tasks", "controller" => "tasks", "model" => "task"],["table" => "opinions", "controller" => "legal_opinions", "model" => "opinion"],["table" => "opinions", "controller" => "legal_opinions", "model" => "conveyancing"], ["table" => "legal_case_hearings", "controller" => "cases", "model" => "legal_case_hearing"], ["table" => "contract", "controller" => "contracts", "model" => "contract"]];
            ...
            foreach ($custom_fields as $key => $custom_field) {
                ...
                switch ($custom_field["type"]) {
                    ...
                    case "number":
                        $custom_field_data = ["field_name" => "customFields[" . $custom_field["id"] . "][text_value]", "field_type" => $custom_field["type"], "field_value" => $custom_field["text_value"], "field_extra" => "dir=\"auto\" id=\"custom-field-" . $custom_field["id"] . "\" class=\"form-control\" field-type=\"" . $custom_field["type"] . "\" " . (isset($extra_fields["form"]) ? "form=\"" . $extra_fields["form"] . "\"" : ""), "field_options" => ""];
                        break;
                    default:  $custom_field_data += ["record_id" => $record_id];
                }
